...
const baseClass =
  "relative inline-flex items-center justify-center overflow-hidden rounded-full px-5 py-5 text-sm font-semibold tracking-wide transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-red/70";
