    ...
    <section id="coverage" className={sectionContainer}>
      <div className="w-full min-w-0 items-start grid grid-cols-1 lg:grid-cols-2 gap-4">
        <SectionHeading
          ...
          title="We Deliver to 100+ Countries Worldwide"
          description="From Ahmedabad to USA, UK, Canada, Australia, UAE, Germany, Singapore & beyond your parcel reaches every corner of the globe."
        />
