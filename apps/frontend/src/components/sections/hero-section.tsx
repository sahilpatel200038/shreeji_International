...
import { scrollToSection } from "@/components/sections/navbar";
        ...
        <div className="mx-auto w-full max-w-2xl space-y-8 text-center lg:mx-0 lg:max-w-xl lg:text-left">
          ...
          >
            ...
            <p className="mt-5 max-w-2xl text-lg text-white/80">
              Ship documents, parcels, and cargo to destinations worldwide with transparent tracking, secure handling, and premium support.
            </p>
          </motion.div>
          ...
          >
            <Button href="tel:+919510813076" className="z-10 cursor-pointer" >
              Book Free Pickup
            </Button>
            {/* <Button
              href="tel:+919510813076"
              variant="secondary"
              className="flex items-center gap-2 border-white/35 text-white cursor-pointer z-10"
            >
              <Phone size={15} />
              Call for Free Quote
            </Button> */}
